...
export class ThreeSceneEngine {
  constructor(container, T, TransformControls) {
    ...
    this.editSelection={type:'camera',id:'camera'}; this.cameraEditKey='start'; this.transformMode='translate'; this.transformSpace='world'; this.gizmoDragging=false; this.onDocumentEdit=null;
